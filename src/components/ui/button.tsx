      ...
      <button
        ...
        className={cn(
          'inline-flex items-center justify-center gap-2 font-medium rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none',
          {
            ...
            'bg-white text-black border border-neutral-200 hover:bg-neutral-50 focus-visible:ring-neutral-400': variant === 'secondary',
            'text-neutral-600 hover:text-black hover:bg-neutral-100 focus-visible:ring-neutral-400': variant === 'ghost',
            'bg-red-600 text-white hover:bg-red-700 focus-visible:ring-red-600': variant === 'danger',
            'border border-neutral-200 text-neutral-700 hover:border-neutral-300 hover:bg-neutral-50 focus-visible:ring-neutral-400': variant === 'outline',
          },
          {
